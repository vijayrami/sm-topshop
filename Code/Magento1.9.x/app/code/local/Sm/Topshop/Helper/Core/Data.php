...
class Sm_Topshop_Helper_Core_Data extends Mage_Core_Helper_Data
{
    const XML_PATH_MINIFY_ENABLE_YUICOMPRESSOR  = 'topshop_cfg/advanced/enable_yuicompressor';
	const XML_PATH_MINIFY_ENABLE                = 'topshop_cfg/advanced/compress_css_js';
