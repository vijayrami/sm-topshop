...
class Sm_Supercategories_Block_Adminhtml_System_Config_Form_Field_Additem extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
	...
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
	{
		...
		$html = '<div id="supercategories_cfg_source_options_product_additem">' . $html . '</div>';
		return $html;
	}
}