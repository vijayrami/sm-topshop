...
//{
	...
	class YtTheme {
		...
		function templateurl(){
			return Mage::getBaseDir('app')."/design/frontend/".$this->template."/default";
		}

		function skinurl(){
			return Mage::getBaseUrl('skin')."frontend/".$this->template."/default";
		}
